...
build/linux: 
	...
	cp env.example build/env.example && cp test/conn-test/conn-test.env.example build/conn-test.env.example && mkdir -p build/test/key &&  cp  test/key/* build/test/key/
